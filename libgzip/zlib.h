...
extern int gz_compress (Byte *dest,   uLong *destLen,
...
/*
   ...
   input file is mmap'ed.
     gz_compress returns Z_OK if success, Z_MEM_ERROR if there was not
   enough memory, Z_BUF_ERROR if there was not enough room in the output
   buffer.
*/

extern int gz_uncompress (Byte *dest,   uLong *destLen,
				 const Byte *source, uLong sourceLen);
/*
   ...
   input file is mmap'ed.
     ...
     gz_uncompress returns Z_OK if success, Z_MEM_ERROR if there was not
   enough memory, Z_BUF_ERROR if there was not enough room in the output
...
uLong *get_crc_table (void); /* can be used by asm versions of crc32() */
