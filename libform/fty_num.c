...
/*---------------------------------------------------------------------------
|   Facility      :  libnform  
|   Function      :  static int Check_Numeric_Field(FIELD * field,
|                                                    const void * argp)
|   
...
+--------------------------------------------------------------------------*/
static int Check_Numeric_Field(FIELD * field, const void * argp)
{
...
/*---------------------------------------------------------------------------
|   Facility      :  libnform  
|   Function      :  static int Check_Numeric_Character(
|                                      int c,
|                                      const void * argp)
|   
...
+--------------------------------------------------------------------------*/
static int Check_Numeric_Character(int c, const void * argp)
{
  const numericARG *argn = (const numericARG *)argp;
  struct lconv* L  = argn->L;  
