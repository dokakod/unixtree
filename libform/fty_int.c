...
/*---------------------------------------------------------------------------
|   Facility      :  libnform  
|   Function      :  static int Check_Integer_Field(
|                                                    FIELD * field,
|                                                    const void * argp)
|   
...
+--------------------------------------------------------------------------*/
static int Check_Integer_Field(FIELD * field, const void * argp)
{
...
/*---------------------------------------------------------------------------
|   Facility      :  libnform  
|   Function      :  static int Check_Integer_Character(
|                                      int c,
|                                      const void * argp)
|   
...
+--------------------------------------------------------------------------*/
static int Check_Integer_Character(int c, const void * argp)
{
