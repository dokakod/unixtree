...
/*---------------------------------------------------------------------------
|   Facility      :  libnform  
|   Function      :  static int Check_Alpha_Field(
|                                      FIELD * field,
|                                      const void * argp)
|   
...
+--------------------------------------------------------------------------*/
static int Check_Alpha_Field(FIELD * field, const void * argp)
{
...
/*---------------------------------------------------------------------------
|   Facility      :  libnform  
|   Function      :  static int Check_Alpha_Character(
|                                      int c,
|                                      const void * argp)
|   
...
+--------------------------------------------------------------------------*/
static int Check_Alpha_Character(int c, const void * argp)
{
